...
-- Listado de las oficinas de España con detalle de la ciudad y el teléfono.
...
-- Devuelve un listado con el nombre, apellidos y email de los empleados que sean Representantes de ventas.
SELECT nombre, apellido1, apellido2, email
FROM empleado
WHERE puesto = 'Representante ventas';

-- Conocer la cantidad de empleados de la compañía por puesto
SELECT puesto, COUNT(codigo_empleado) AS cantidad_empleado
FROM empleado
GROUP BY puesto
ORDER BY puesto 
...
-- Obtener un listado con el nombre de cada cliente y 
-- el nombre y apellido de su representante de ventas
SELECT c.nombre_cliente, e.nombre AS rep_ventas, e.apellido1 AS rep_ventas
FROM cliente c
JOIN empleado e ON c.codigo_empleado_rep_ventas = e.codigo_empleado;

-- Listar todos los clientes y sus empleados representantes de ventas correspondientes 
-- (incluyendo clientes sin representantes de ventas).

SELECT c.nombre_cliente, e.nombre AS nom_rep_ventas, e.apellido1 AS apellido_rep_ventas
FROM cliente c
...
FROM producto
WHERE precio_venta > 100 AND gama = 'Ornamentales'
...
-- SELECT * FROM pago;
SELECT codigo_cliente, COUNT(codigo_cliente) as Cantidad_pago_2008 
FROM pago
WHERE YEAR(fecha_pago) = 2008
GROUP BY codigo_cliente;

-- Agregar a la consulta anterior el nombre del cliente que efectuó el pago
SELECT p.codigo_cliente, c.nombre_cliente, COUNT(p.codigo_cliente) as Cantidad_pago_2008 
FROM pago p
